...
const About = () => {
  ...
  return (
    ...
    <div className="d-flex justify-content-center flex-column me-4 align-items-center">
      <h2 className="secondary-title">Welcome to <span>Bright Kids</span></h2>
    ...
    {/* teachers container */}
    <h3 className="secondary-title mt-5 mb-3">Our Professional <span>Teachers</span></h3>
    <Row xs={1} md={4} className="g-4 mb-5">
      {
        teachers.map(teacher => <ShowTeacher key={teacher.id} teacher={teacher}></ShowTeacher>)
      }
    </Row>
</Container>
</>
